...
export class InitialSchema1770356128169 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_4ede76208970cde9dc26f4a4f8\` ON \`settings\``,
    );

...
export class NotificationListener {
    ...
    async handleUserCreatedEvent(payload: { userUuid: string; email: string; phoneNumber?: string }) {
        this.logger.log(`Handling user.created event for ${payload.userUuid}`);
    ...
    async handleSecurityLoginEvent(payload: { userUuid: string; email: string; location?: string }) {
    ...
    async handleCampaignLiveEvent(payload: { userUuid: string; campaignName: string; email: string }) {

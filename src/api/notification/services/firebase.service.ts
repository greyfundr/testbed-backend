...
export class FirebaseService {
    ...
    async sendPushNotification(token: string, title: string, body: string, data?: any): Promise<any> {
        try {
            ...
            this.logger.warn('Firebase Messaging implementation is a placeholder. Please provide Firebase Credentials.');
